/**
 * PgAdmin Setup Script for VS Code
 * 
...
dotenv.config({ path: path.join(__dirname, '.env.pgadmin') });
...
async function setupPgAdmin() {
  ...
  try {
    ...
    console.log('1. Pressing F5, or');
    console.log('2. Running "npm run dev" in the terminal');
