...
const SchemeLpcdImport = () => {
  ...
  const excelMutation = useMutation({
    mutationFn: async () => {
      ...
      return apiRequest('/api/scheme-lpcd/import/excel', {
        method: 'POST',
        body: formData,
        headers: {
    ...
    onSuccess: (data) => {
      ...
      queryClient.invalidateQueries({ queryKey: ['/api/scheme-lpcd'] });
  ...
  const csvMutation = useMutation({
    mutationFn: async () => {
      ...
      return apiRequest('/api/scheme-lpcd/import/csv', {
        method: 'POST',
        body: formData,
        headers: {
          // Don't set Content-Type here, it will be automatically set with the boundary
  ...
  const amravatiMutation = useMutation({
    mutationFn: async () => {
      ...
      return apiRequest('/api/scheme-lpcd/import/amravati', {
        method: 'POST',
        body: formData,
        headers: {
          // Don't set Content-Type here, it will be automatically set with the boundary
  ...
  const handleTemplateDownload = () => {
    ...
    window.open('/api/scheme-lpcd/template', '_blank');
...
export default SchemeLpcdImport;