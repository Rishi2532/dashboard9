                        ...
                        <Table className="border-collapse">
                          ...
                          <TableBody>
                            {paginatedSchemes.map((scheme, index) => {
                              ...
                              const hasActiveIssue = villageLevelIssues.some((i: any) => i.status === 'Active');                              return (
                                <TableRow
                                  ...
                                  className={`village-item ${hasActiveIssue
                                ...
                                >
                                  ...
                                  <TableCell className="border-b border-blue-200 text-center align-middle max-w-[150px]">
                                    {villageLevelIssues.length > 0 ? (
                                      (() => {
                                        const activeIssue = villageLevelIssues.find((i: any) => i.status === 'Active');
                                          ...
                                          <Button
                                            ...
                                            onClick={(e) => {
                                              ...
                                              setSelectedRemarkDetails({
                                                ...
                                                title: `Remarks/Issues for ${scheme.village_name} (${scheme.scheme_name})`,
                                              });
                                            }}
                                          >
